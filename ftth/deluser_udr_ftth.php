                            ...
                            <div class="sparkline12-list shadow-reset mg-t-30">
                                <div class="sparkline12-hd">
                                    <div class="main-sparkline12-hd">
                                        <h1>FTTH Delete HSS User Only</h1>
                                    </div>
                                </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="row">
                                                                        ...
                                                                        <button class="btn btn-sm btn-primary login-submit-cs" type="submit" id="submit1" name="submit1" onclick="deluserats()">Delete User UDR HSS</button>
