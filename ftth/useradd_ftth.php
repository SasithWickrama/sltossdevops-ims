                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="row">
                                                                        <div class="col-lg-6">
                                                                             <select class="form-control custom-select-value" disabled id="vtype" name="vtype">     
														...
														<div class="form-group-inner">
                                                            <div class="login-btn-inner">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <div class="login-horizental cancel-wp pull-left">
                                                                            <button class="btn btn-sm btn-primary login-submit-cs" id="submitcre2" name="submit"  onclick="adduserftth()" style="display:none;">Create User</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
