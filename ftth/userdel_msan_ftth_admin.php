...
function adduserftth(){
	...
	document.getElementById('hss').innerHTML = "DELETEING USER....";
	...
	if(olt == 'NOKIA'){
		var url = "MSAN_SCR_DEL|5|MSAN_TYPE*NOKIA|ONT_PORT*1|FTTH_ZTE_PID*"+port+"|FTTH_HUW_VP*"+vport+"|ADSL_ZTE_DNAME*"+dname;
	}
	if(olt == 'HUAWEI'){
		var p = port.split("-")
		var url = "MSAN_SCR_DEL|7|MSAN_TYPE*HUAWEI|ONT_PORT*1|FTTH_HUW_FN*"+p[0]+"|FTTH_HUW_SN*"+p[1]+"|FTTH_HUW_PN*"+p[2]+"|FTTH_HUW_VP*"+vport+"|ADSL_ZTE_DNAME*"+dname;
	}
...
xmlhttp.onreadystatechange=function() {
    if (xmlhttp.readyState==4 && xmlhttp.status==200) {
		...
		if(repx[0].trim() == "0"){
			document.getElementById('hss').innerHTML = "USER DELETED";
			...
			document.getElementById('hss').innerHTML = "USER DELETE ERROR";
                            ...
                            <div class="sparkline12-list shadow-reset mg-t-30">
                                <div class="sparkline12-hd">
                                    <div class="main-sparkline12-hd">
                                        <h1>Delete FTTH User from MSAN</h1>
                                    </div>
                                </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="row">
																		...
																		<div class="col-lg-2">
                                                                           <div class="form-select-list">
                                                                                <label class="login2 pull-right pull-right-pro" style="color: blue;" id="hss"></label>
                                                                            </div> 
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="row">
                                                                        <div class="col-lg-6">
                                                                            <input type="text"  class="form-control" id="mtid">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
														...
														<div class="form-group-inner">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="row">
                                                                        <div class="col-lg-6">
                                                                            <input type="text"  class="form-control" id="vport">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-group-inner">
                                                         ...
                                                         <div class="col-lg-2">   
                                                            ...
                                                            <div class="login-horizental cancel-wp pull-left" align="right">
                                                                ...
                                                                <button id="submitcre1" name="submit"  onclick="adduser()" style="display:none;" class="btn btn-sm btn-primary login-submit-cs">Create User</button>
                                                         ...
                                                         <div class="col-lg-2">
                                                          ...
                                                          <div class="login-horizental cancel-wp pull-left" align="right">
                                                            ...
                                                            <button id="submitcre2" name="submit"  onclick="adduserftth()" style="display:none;" class="btn btn-sm btn-primary login-submit-cs">Delete FTTH User from MSAN</button>  
