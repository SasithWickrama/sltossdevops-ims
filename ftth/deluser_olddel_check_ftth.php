...
xmlhttp.onreadystatechange=function() {
	...
	alert("No Delete SO for this number");
	document.getElementById("submit2").style.display = "";
		   ...
		   area_glob = repx[5];
		   document.getElementById("submitDEL").style.display = ""; 
		   }
		   
        }
    }
    xmlhttp.open("GET","../dbFunction/getdetails.php?q="+tp+"&r=ftthdeleteeso",true);
    xmlhttp.send();
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="login-btn-inner">
                                                                <div class="row">
                                                                    ...
                                                                    <button class="btn btn-sm btn-primary login-submit-cs" type="submit" id="submit2" name="submit" onclick="gettiddetails()">Get details</button>
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="row">
                                                                       ...
                                                                       <div class="col-lg-2">
                                                                        ...
                                                                        <button class="btn btn-sm btn-primary login-submit-cs" type="submit" id="submitDEL" name="submit" onclick="deluserhss()">Delete User</button>
