...
xmlhttp.onreadystatechange=function() {
	...
	console.log(xmlhttp.responseText);
		...
		if(repx[0].trim() == "0"){
			...
			document.getElementById('wmsg').innerHTML = repx ;
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="login-btn-inner">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <div class="login-horizental cancel-wp pull-left">
                                                                            <button class="btn btn-sm btn-primary login-submit-cs" type="submit" id="submitcre1" name="submit" onclick="adduserhss()" style="display: none;">UDR_IMS_HSS_ADD</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
