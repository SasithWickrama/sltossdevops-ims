                                                        ...
                                                        <div class="form-group-inner">
                                                         ...
                                                         <div class="col-lg-2">   
                                                            ...
                                                            <div class="login-horizental cancel-wp pull-left" align="right">
                                                                ...
                                                                <button id="submitcre1" name="submit"   style="display:none;" class="btn btn-sm btn-primary login-submit-cs">Create User</button>
                                                         ...
                                                         <div class="col-lg-2">
                                                          ...
                                                          <div class="login-horizental cancel-wp pull-left" align="right">
                                                            ...
                                                            <button id="submitcre2" name="submit"  onclick="adduserftth()" style="display:none;" class="btn btn-sm btn-primary login-submit-cs">Create FTTH User</button>  
