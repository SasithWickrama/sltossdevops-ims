...
xmlhttp.onreadystatechange=function() {
	...
	//alert(xmlhttp.responseText);
		  ...
		  if(repx[1] != '1'){
			  ...
			  alert("THERE ARE NO DELETE SERVICE ORDERS FOR THIS NUMBER");
		  }
		   
        }
    }
    xmlhttp.open("GET","../dbFunction/getdetails.php?q="+tp+"&r=delcheck",true);
    xmlhttp.send();
}
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-2">
                                                                           <div class="form-select-list">
                                                                                <label class="login2 pull-right pull-right-pro" style="color: blue;" id="agcf">AGCF</label>
                                                                            </div> 
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="login-btn-inner">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <div class="login-horizental cancel-wp pull-left">
                                                                           <!--  <button class="btn btn-white" type="submit">Cancel</button> -->
                                                                            <button class="btn btn-sm btn-primary login-submit-cs" id="submitDEL" name="submit"  onclick="deluser()" >Delete user</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
