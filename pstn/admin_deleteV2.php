...
function deluseragcf(){
	document.getElementById('agcf').innerHTML = "DELETING USER IN AGCF....";
...
xmlhttp.onreadystatechange=function() {
    ...
    xmlhttp.open("GET","../dbFunction/runphptest.php?q=DELHSS-1-tpno*"+tp,true);
    xmlhttp.send();
                                                                    ...
                                                                    <div class="row">                                                                  
                                                                        <div class="col-lg-6">
                                                                            <div class="form-select-list">
                                                                                <input type="text" id="tpno" class="form-control" placeholder="">
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <div class="login-horizental cancel-wp pull-left">
                                                                            <button class="btn btn-sm btn-primary login-submit-cs" id="submit2" name="submit"  onclick="gettiddetails()">Get details</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="row">
                                                                     ...
                                                                     <!--        <div class="form-select-list">
                                                                            ...
                                                                            <input type="text" disabled class="form-control" id="mname" placeholder="" />
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-4">
                                                                           <!--  <div class="form-select-list">
                                                                            ...
                                                                            <input type="text" disabled class="form-control" id="mindex" placeholder="" />
                                                                        </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-4">
                                                                           <!--  <div class="form-select-list">
                                                                            ...
                                                                            <input type="text" disabled class="form-control" id="mmodel" placeholder="" />
                                                                        </div>
                                                                    ...
                                                                    <div class="row">
                                                                        <div class="col-lg-4">
                                                                           <!--  <div class="form-select-list">
                                                                            ...
                                                                            <input type="text" disabled class="form-control" id="mip" placeholder="" />
                                                                        </div>
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="row">
                                                                        <div class="col-lg-4">
                                                                             ...
                                                                             <input type="text" id="mtid"  disabled class="form-control" placeholder="" />
                                                                        </div>
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <div class="login-horizental cancel-wp pull-left">
                                                                           <!--  <button class="btn btn-white" type="submit">Cancel</button> -->
                                                                            <button class="btn btn-sm btn-primary login-submit-cs"  id="submit1" name="submit"  onclick="deluseragcf()" >Delete user</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
