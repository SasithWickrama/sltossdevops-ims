...
xmlhttp.onreadystatechange=function() {
	...
	//alert(xmlhttp.responseText);
		  ...
		  alert("Cannot Create FTTH Numbers");
		   }
		   
		  if(repx[1] != '1'){
			  document.getElementById("submitcre1").style.display = "none";
			  document.getElementById("submitcre2").style.display = "none";
			  document.getElementById("submitcre3").style.display = "none";
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <div class="login-horizental cancel-wp pull-left">
                                                                           <!--  <button class="btn btn-white" type="submit">Cancel</button> -->
                                                                            <button class="btn btn-sm btn-primary login-submit-cs"  id="submit2" onclick="gettiddetails()" name="submit">Get details</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
														...
														<div class="form-group-inner">
                                                            <div class="login-btn-inner">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <div class="login-horizental cancel-wp pull-left">
                                                                            <button class="btn btn-sm btn-primary login-submit-cs" type="submit" id="submitcre3" name="submit" onclick="adduseragcf()" style="display: none;">SOP PROV IMS</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
