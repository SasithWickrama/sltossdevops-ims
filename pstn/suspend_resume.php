                                            ...
                                            <div class="col-lg-12">
                                                <div class="all-form-element-inner">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro"  >Outgoing bar</label>
                                                                </div>
                                                                    <div class="col-lg-9">
                                                                              <div class="row">
                                                                        ...
                                                                        <div class="col-lg-6">
                                                                            <div class="form-select-list">
                                                                                <button class="btn btn-sm btn-primary login-submit-cs" id="submit2" name="submit"  onclick="ogb()">Outgoing bar</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    </div>
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro" >Incomming BAR</label>
                                                                </div>
                                                                    <div class="col-lg-9">
                                                                              <div class="row">
                                                                        <div class="col-lg-6">
                                                                            <div class="form-select-list">
                                                                                <button class="btn btn-sm btn-primary login-submit-cs" id="submit2" name="submit"  onclick="icb()" >Incomming BAR</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        ...
                                                                        <div class="col-lg-6">
                                                                            <div class="form-select-list">
                                                                                <button class="btn btn-sm btn-primary login-submit-cs" id="submit2" name="submit"  onclick="removeogb()">RESUME</button>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
