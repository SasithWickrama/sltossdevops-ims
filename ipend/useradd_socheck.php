...
xmlhttp.onreadystatechange=function() {
    ...
    xmlhttp.open("GET","../dbFunction/runphptest.php?q=UDR_IPEND_CPWD|2|tpno*"+tp+"|PWD*"+pwd,true);
    xmlhttp.send();
...
xmlhttp.onreadystatechange=function() {
    ...
    xmlhttp.open("GET","../dbFunction/getdetails.php?q="+tp+"&r=ipendcreateso",true);
    xmlhttp.send();
}
                            ...
                            <div class="sparkline12-list shadow-reset mg-t-30">
                                <div class="sparkline12-hd">
                                    <div class="main-sparkline12-hd">
                                        <h1>IP-Endpoint Change Authentication</h1>
                                    </div>
                                </div>
