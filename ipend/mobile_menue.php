                                ...
                                <nav id="dropdown">
                                    ...
                                    <!--         <ul class="collapse dropdown-header-top">
										...
										<ul id="others" class="collapse dropdown-header-top">
                                                ...
                                                <li><a href="useradd_socheck">Change Authentication</a>
                                                </li>
										...
										<li><a data-toggle="collapse" data-target="#others" href="#">Admin <span class="admin-project-icon adminpro-icon adminpro-down-arrow"></span></a>
                                    
										<ul id="others" class="collapse dropdown-header-top">

                                                <li><a href="useradd">Create User</a>
                                                </li>
