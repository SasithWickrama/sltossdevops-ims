...
function runinWEL(tp, command){	
	var xmlhttp=new XMLHttpRequest();
xmlhttp.onreadystatechange=function() {
    if (xmlhttp.readyState==4 && xmlhttp.status==200) {
		 if(xmlhttp.responseText.trim() == "0"){
				document.getElementById("wel").innerHTML  = "SUCCESS";
			}else{
				document.getElementById("wel").innerHTML  = "ERROR "+xmlhttp.responseText;
			}
        }
    }
	xmlhttp.open("GET","../dbFunction/runcorjava.php?q=TrunkNumberBlocking*WEL_IBCF*3004*"+tp+"*"+command,true);
    xmlhttp.send();
	document.getElementById("submit").style.display = "";
}
                            ...
                            <div class="sparkline12-list shadow-reset mg-t-30">
                                <div class="sparkline12-hd">
                                    <div class="main-sparkline12-hd">
                                        <h1>COR - Trunk Number Blocking  </h1>
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <div class="login-horizental cancel-wp pull-left">
                                                                           <!--  <button class="btn btn-white" type="submit">Cancel</button> -->
                                                                            <button class="btn btn-sm btn-primary login-submit-cs" id="submit" name="submit"  onclick="runinHQ()">Run Command</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="row">
                                                                     ...
                                                                     <!--        <div class="form-select-list">
                                                                             ...
                                                                             <label class="login2 pull-left pull-left-pro" id="hq">HQ</label>
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="row">
                                                                        <div class="col-lg-6">
                                                                           ...
                                                                           <label class="login2 pull-left pull-left-pro" id="wel">WEL</label>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
