...
<body class="materialdesign">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-2">
                                                                    <div class="form-select-list">
                                                                        <label class="login2 pull-right pull-right-pro" style="color: blue;" id="delonu">DELETE ONU</label>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-2">
                                                                    <div class="form-select-list">
                                                                        <label class="login2 pull-right pull-right-pro" style="color: blue;" id="delbb" >DELETE BB</label>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-2">
                                                                    <div class="form-select-list">
                                                                    <label class="login2 pull-right pull-right-pro" style="color: blue;" id="deliptv" >DELETE BB</label>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-2">
                                                                    <div class="form-select-list">
                                                                        <label class="login2 pull-right pull-right-pro" style="color: blue;" id="msh"></label>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="login-btn-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <div class="login-horizental cancel-wp pull-left">
                                                                    <button class="btn btn-sm btn-primary login-submit-cs" id="cabc" name="submit" onclick="deletecab()" style="display:none;">Delete FAB</button>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <div class="login-horizental cancel-wp pull-left">
                                                                    ...
                                                                    <button class="btn btn-sm btn-primary login-submit-cs" id="voicec" name="submit" onclick="deletevoice()" style="display:none;">Delete Voice</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <div class="login-horizental cancel-wp pull-left">
                                                                    ...
                                                                    <button class="btn btn-sm btn-primary login-submit-cs" id="bbc" name="submit" onclick="deletebb()" style="display:none;">Delete BB</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="login-btn-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <div class="login-horizental cancel-wp pull-left">
                                                                    <button class="btn btn-sm btn-primary login-submit-cs" id="iptvc" name="submit" onclick="deleteiptv()" style="display:none;">Delete IPTV</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
    ...
    <script type="text/javascript">
        ...
        function deletecab() {
            ...
            if ($("#olt").val() == 'ZTE') {
                var att = "{'ADSL_ZTE_DNAME':'" + $("#dname").val() + "','FTTH_ONT_SN':'" + $("#ontsn").val() + "','FTTH_ZTE_PID':'" + $("#port").val() + "','FTTH_HUW_VP':'" + $("#vport").val() + "'}";

                $("#delonu").text("DELETING ONU");

                $.post("../dbFunction/runpython.php", {
                    OLT: $("#olt").val(),
                    SVTYPE: "FAB",
                    COMMAND: "FTTH_DEL_ONU",
                    ATT: att,
                    REGID: $("#regid").val()
                }, function(result) {
            ...
            if ($("#olt").val() == 'HUAWEI') {
                ...
                var att = "{'ADSL_ZTE_DNAME':'" + $("#dname").val() + "','FTTH_HUW_FN':'" + p[0] + "','FTTH_HUW_SN':'" + p[1] + "','FTTH_HUW_PN':'" + p[2] + "','FTTH_HUW_VP':'" + $("#vport").val() + "'}";
            ...
            if ($("#olt").val() == 'NOKIA') {
                ...
                /*    if ($("#bb").val()) {
                        $("#delbb").show();
                        $("#delbb").text("DELETING BB");
                        $.post("../dbFunction/runpython.php", {
                            OLT: $("#olt").val(),
                            SVTYPE: "BB",
                            COMMAND: "DEL_NK_INTERNET",
                            ATT: att,
                            REGID: $("#regid").val()
                        }, function(result) {
