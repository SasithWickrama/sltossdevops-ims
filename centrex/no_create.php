...
<head>
    ...
    <script type="text/javascript">
        ...
        function getdata(){
            ...
            $.get("../dbFunction/centrexDetails.php?q=" + reg + "&r=createso", {}, function(data, status) {
                console.log('return data ' + data);
                if (data.length !== 0) {
                    if(data[0].CENTREX == "Y"){
                    $("#svtype").val(data[0].SERO_SERT_ABBREVIATION);
                    $("#groupid").val(data[0].GROUP_ID);
                    $("#shortcode").val(data[0].SHORT_CODE);
                    $("#cxsbr").val(data[0].CXSBR);
                    $("#cxsg").val('2');
                    }else{
                        alert("SF_CENTREX value is not Y");
                    }
                }else{
        ...
        function createNo(){
            ...
            var cxsg = $("#cxsg").val();
            if(cxsg.length == 0){
                alert("CXSG Value Cannot be Null");
                return;
            }
            if(shortcode.length < 5 && shortcode.length > 2){
                alert("Short Code length should be between 3-4");
                return;
            }
            ...
            $.post("../dbFunction/centrexPython.php?action=CREATE", {               
                tp: reg,
                group: $("#groupid").val(),
                ...
                if (temp[0] == "0") {
                    ...
                    if( $("#svtype").val() == "V-VOICE COPPER"){
                        $.post("../dbFunction/centrexPython.php?action=CREATECOPPER", {               
                            tp: reg,
                            clen: $("#shortcode").val().length
                        }, function(result) {
                            var temp = result.split("#");
                            if (temp[0] == "0") {
                                $("#msg2").text("SUCCESS");                              
                                        ...
                                        <div class="col-lg-12">
                                            <div class="all-form-element-inner">
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <input type="text" disabled class="form-control" id="groupid">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <input type="text" disabled class="form-control" id="shortcode">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        <div class="col-lg-3">
                                                            <label class="login2 pull-right pull-right-pro">CXSBR</label>
                                                        </div>
                                                        <div class="col-lg-9">
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <input type="text" disabled class="form-control" id="cxsbr">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        <div class="col-lg-3">
                                                            <label class="login2 pull-right pull-right-pro">SUB GROUP</label>
                                                        </div>
                                                        <div class="col-lg-9">
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <input type="text" class="form-control" id="cxsg">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="login-btn-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <div class="login-horizental cancel-wp pull-left">
                                                                    <button class="btn btn-sm btn-primary login-submit-cs" type="submit" id="createbtn" name="createbtn" onclick="createNo()">Create</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
