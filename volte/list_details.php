...
{	
	...
	tp = tp.slice( 1 );
    window.location.href = "http://172.25.17.220//imsportal/details.php?q=LIST_ATS_VOLTE-1-tpno*"+tp;
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <div class="login-horizental cancel-wp pull-left">
                                                                            <button class="btn btn-sm btn-primary login-submit-cs" type="submit" id="submit2" name="submit"  onclick="getdetails()">Get details</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
