...
xmlhttp.onreadystatechange=function() {
    ...
    xmlhttp.open("GET","../dbFunction/getdetails.php?q="+tp+"&r=createchecklte",true);
    xmlhttp.send();
}
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="login-btn-inner">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <div class="login-horizental cancel-wp pull-left">
                                                                            <button class="btn btn-sm btn-primary login-submit-cs"  id="submitcre2" name="submit"  onclick="adduserlte()" style="display: none;">Create LTE User</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
