...
xmlhttp.onreadystatechange=function() {
    if (xmlhttp.readyState==4 && xmlhttp.status==200) {
		...
		if(repx[0] == 0){
			document.getElementById('wmsg2').innerHTML = "User Suspended" ;
		}else{
    ...
    xmlhttp.open("GET","../dbFunction/runphptest.php?q=VoLTE_BAR_OUTGOING-1-tpno*"+tp,true);
    xmlhttp.send();
...
xmlhttp.onreadystatechange=function() {
    ...
    xmlhttp.open("GET","../dbFunction/runphptest.php?q=VoLTE_BAR_INCOMING-1-tpno*"+tp,true);
    xmlhttp.send();
...
xmlhttp.onreadystatechange=function() {
    ...
    xmlhttp.open("GET","../dbFunction/runphptest.php?q=VoLTE_Remove_OGB-1-tpno*"+tp,true);
    xmlhttp.send();
}
...
xmlhttp.onreadystatechange=function() {
    ...
    xmlhttp.open("GET","../dbFunction/runphptest.php?q=VoLTE_Remove_ICB-1-tpno*"+tp,true);
    xmlhttp.send();
}
                                                            ...
                                                            <div class="login-btn-inner">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                     ...
                                                                     <button class="btn btn-sm btn-primary col-lg-3 login-submit-cs" type="submit" id="submit2" name="submit"  onclick="ogb()">OutGoing BAR</button>
                                                            ...
                                                            <div class="login-btn-inner">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                     ...
                                                                     <button class="btn btn-sm btn-primary col-lg-3 login-submit-cs" type="submit" id="submit2" name="submit"  onclick="icb()">Incomming BAR</button>
                                                            ...
                                                            <div class="login-btn-inner">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                     ...
                                                                     <button class="btn btn-sm btn-primary col-lg-3 login-submit-cs" type="submit" id="submit2" name="submit"  onclick="removeogb()">RESUME</button>
