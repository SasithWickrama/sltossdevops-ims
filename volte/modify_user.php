...
xmlhttp.onreadystatechange=function() {
    ...
    xmlhttp.open("GET","../dbFunction/runphptest.php?q=DEL_ATS_VOLTE-2-tpno*"+tp+"-source*"+sou,true);
    xmlhttp.send();
...
function adduserats(tp){
	...
	document.getElementById('ats1').innerHTML = "CREATING USER IN ATS....";
	document.getElementById('ats1').className = "label label-warning";
...
xmlhttp.onreadystatechange=function() {
    if (xmlhttp.readyState==4 && xmlhttp.status==200) {
		var repx = xmlhttp.responseText.split("#");	
		if(repx[0].trim() == "0"){
			document.getElementById('ats1').innerHTML = "USER CREATED IN ATS";
			document.getElementById('ats1').className = "label label-success";
			
		}else{
			document.getElementById('wmsg').innerHTML = repx[1] ;
			document.getElementById('wmsg').className = "label label-danger";
			document.getElementById('ats1').innerHTML = "USER CREATE ERROR IN ATS";
			document.getElementById('ats1').className = "label label-danger";
		}
...
function checkcre(){
	var tp = document.getElementById("tpno").value;
		...
		if(tp.length == 10){
	   			if(!isNumeric(tp)){
					alert("Please Enter a valid LTE 10 digit NO");
	   				return ;
	   			}
	}else{
		alert("Please Enter a valid LTE 10 digit NO");
...
xmlhttp.onreadystatechange=function() {
    ...
    xmlhttp.open("GET","../dbFunction/getdetails.php?q="+tp+"&r=modchecklte",true);
    xmlhttp.send();
}
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-2">
                                                                           <div class="form-select-list">
                                                                                <label class="login2 pull-right pull-right-pro" style="color: blue;" id="ats">Dell ATS</label>
                                                                            </div> 
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-2">
                                                                           <div class="form-select-list">
                                                                                <label class="login2 pull-right pull-right-pro" style="color: blue;" id="ats1">Create ATS</label>
                                                                            </div> 
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="login-btn-inner">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <div class="login-horizental cancel-wp pull-left">
                                                                            <button class="btn btn-sm btn-primary login-submit-cs" type="submit" id="submitcre1" name="submit"  onclick="deluserats()" style="display: none;">Modify User</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="login-btn-inner">
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <div class="login-horizental cancel-wp pull-left">
                                                                            <button class="btn btn-sm btn-primary login-submit-cs" type="submit" id="submitcre2" name="submit"  onclick="deluserats()" style="display: none;">Modify User</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
