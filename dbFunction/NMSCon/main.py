...
if __name__ == '__main__':
    ...
    # HUAWEI NMS
        ...
        if sys.argv[2] == 'BB':
            if sys.argv[3] == 'FTH_CREATE_SER_PORT_BB':
                ...
                result = Huaweicreate.huaweiCreate('FTTH_BB_SERPRT.xml', data)
                print(result)

        # IPTV CREATE
        if sys.argv[2] == 'IPTV':
            if sys.argv[3] == 'FTH_CREATE_SER_PORT_IPTV':
    ...
    # NOKIA NMS
        ...
        if sys.argv[2] == 'BB':
            if sys.argv[3] == 'DEL_NK_INTERNET':
                result = Nokiadelete.nokiaDelete('DEL_NK_INTERNET.xml', data)
                print(result)

        if sys.argv[2] == 'IPTV':
            if sys.argv[3] == 'DEL_NK_IPTV':
                result = Nokiadelete.nokiaDelete('DEL_NK_IPTV.xml', data)
                print(result)
