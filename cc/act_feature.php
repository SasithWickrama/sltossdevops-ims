...
xmlhttp.onreadystatechange=function() {
	...
	if(xmlhttp.responseText == ""){
		alert('There are no Active Features in clarity');
	}
		var repx = xmlhttp.responseText.split("@");	
		var btns = "<table>"; 
			for(i=0; i<repx.length-1; i++){
				btns += " <tr><td style=\"padding-bottom:10px;\" ><button id=\""+repx[i]+"\" name=\"submit\"  onclick=\"actfeture(this)\" class=\"btn btn-primary\">Activate "+repx[i]+" Feature</button></td><td style=\"padding-right:10px\"><label class=\"label label-default\" for=\"selectbasic\" id=\""+repx[i]+"1\" ></label></td>"
				
				
				if(i+1 < repx.length-1){
					i++;
					btns += " <td style=\"padding-bottom:10px;\" ><button id=\""+repx[i]+"\" name=\"submit\"  onclick=\"actfeture(this)\" class=\"btn btn-primary\">Activate "+repx[i]+" Feature</button></td><td style=\"padding-right:10px\"><label class=\"label label-default\" for=\"selectbasic\" id=\""+repx[i]+"1\" ></label></td></tr>"
				}else{
					btns += "<td></td></tr>";
				}
			}
    ...
    xmlhttp.open("GET","../dbFunction/getdetails.php?q="+tp+"&r=nowfeature",true);
    xmlhttp.send();
}
                                            ...
                                            <div class="col-lg-12">
                                                <div class="all-form-element-inner">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Voice NO</label>
                                                                </div>
                                                                <div class="col-lg-9">
                                                                    <div class="row">
                                                                        <div class="col-lg-6">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="login-btn-inner">
                                                                <div class="row">
                                                                    ...
                                                                    <button class="btn btn-sm btn-primary login-submit-cs" type="button" id="submit2" name="submit" onclick="setfeatures()">Get details</button>
